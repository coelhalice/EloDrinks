...
import { EventConfigForm } from "./budget-details";
  ...
  return (
    <div className="bg-[#101820] min-h-screen py-10 px-4 flex flex-col gap-10">
      ...
      <div className="flex flex-row justify-end mx-20">
        <Button className="flex gap-2 bg-[#9E430E] text-[#fff] hover:bg-[#7A2D0B] w-[250px] rounded-full text-lg font-bold items-center justify-center">
